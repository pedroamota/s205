...
function openPopup() {
    ...
    popup.style.display = 'block'; // Change the display property to 'block' to show the popup
  }
  
  function closePopup() {
    const popup = document.getElementById('meuPopup');
    popup.style.display = 'none'; // Change the display property to 'none' to hide the popup
  }
// Quando o documento estiver pront
